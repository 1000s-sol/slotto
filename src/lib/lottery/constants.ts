...
/** 2% of 0.01 SOL — transferred to BUX vault in `buy_sol_tickets` (post-audit program). */
...
/** Lamports debited per ticket: pot + team + bux + setup (= 0.0105 SOL). Matches on-chain `LAMPORTS_SOL_TICKET_TOTAL`. */
